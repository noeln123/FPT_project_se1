...
<head>
    ...
    <script>
        ...
        document.getElementById('filterForm').addEventListener('submit', function(event) {
            ...
            // alert(queryUrl);
            window.location.href = `/catalogue?${queryUrl}`; // Redirect to the generated URL
        });
        });
    </script>
    <script>
                ...
                <div class="grid__column2">
                    <nav class="category">
                        <div class="icon_category">
                            <img src="{{ asset('img/car_catalogue_icon.png') }}" alt="">
                            ...
                            <ul class="category-list">
                                        ...
                                        <ul>
                                            <li>
                                                <label>
                                                    ...
                                                    <label for="brandtype" class="name_trademark">HyunDai</label>
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input class="check-lable" type="checkbox" name="brandtype" value="2">
                                                    <label for="brandtype" class="name_trademark">KIA</label>
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input class="check-lable" type="checkbox" name="brandtype" value="3">
                                                    <label for="brandtype" class="name_trademark">Toyota</label>
                                                </label>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li class="category-item">
                                    <div onclick="DropDown(this)" href="" id="" class="category-item__link">
                                        <div>
                                            <i class="fa-solid fa-gem category-item__icons"></i>
                                            <span class="filter_name">Vehicle type</span>
                                        </div>
                                        <i class="fa-solid fa-angle-down"></i>
                                    </div>
                                    <div class="show-menu">
                                        <ul>
                                            <li>
                                                <label>
                                                    <input class="check-lable" type="checkbox" name="vehicletype" value='2'></input>
                                                    <label for="vehicletype" class="name_trademark">Hatchback</label>
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input class="check-lable" type="checkbox" name="vehicletype" value='3'></input>
                                                    <label for="vehicletype" class="name_trademark">Sedan</label>
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input class="check-lable" type="checkbox" name="vehicletype" value='4'></input>
                                                    <label for="vehicletype" class="name_trademark">SUV</label>
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input class="check-lable" type="checkbox" name="vehicletype" value='5'></input>
                                                    <label for="vehicletype" class="name_trademark">MPV</label>
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input class="check-lable" type="checkbox" name="vehicletype" value='6'></input>
                                                    <label for="vehicletype" class="name_trademark">Convertible</label>
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input class="check-lable" type="checkbox" name="vehicletype" value='7'></input>
                                                    <label for="vehicletype" class="name_trademark">Wagon</label>
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input class="check-lable" type="checkbox" name="vehicletype" value='8'></input>
                                                    <label for="vehicletype" class="name_trademark">Luxury</label>
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input class="check-lable" type="checkbox" name="vehicletype" value='9'></input>
                                                    <label for="vehicletype" class="name_trademark">Antique</label>
                                                </label>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="sort-menu">
                            ...
                            <div class="sort-menu__show">
                                <ul class="arrange-list">
                                    <a href="{{ route('goCatalogue', array_merge(['filter' => 'price', 'type' => 'low2high'], request()->except('type'))) }}">
                                        <li class="arrange-list__link">Price: Low to High</li>
                                    </a>
                                    <a href="{{ route('goCatalogue', array_merge(['filter' => 'price', 'type' => 'high2low'], request()->except('type')))  }}">
